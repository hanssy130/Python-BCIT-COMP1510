...
#from unittest import testcase <-- for test casing
#from unittest.mock import patch
# if print, do this:
#import io
#above class,
#You can patch above function or above class. It affects if it gets called or not
#@patch("random.randint", return_value=7)
#def test_hey(self, mock_random):
#self.fail() -> self.assertEqual(expectation, hey(any number))

#from lab05.lab05 import generate_syllable
#@patch("lab05.lab05.generate_consonant", return="b")
#@patch("lab05.lab05.genreate_vowel", return="a")
#def test_generate_syllable(self, mock_v, mock_c):
